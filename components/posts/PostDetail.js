  ...
  return (
    <div className="article pb-24 md:pb-0 md:mr-4">
      <Link href="/tech/[slug]" as={`/tech/${slug}`}>
        <a className="font-semibold text-base text-indigo-600 block md:text-xl">{title}</a>
      </Link>
      ...
      <div className="h-10 leading-8 text-sm font-light my-1 md:text-base md:font-hairline" dangerouslySetInnerHTML={{__html: content}}></div>
    </div>
  )
}
